<?php
// $Id: index.php,v 1.13 2005/12/20 15:06:10 okazu Exp $
// ------------------------------------------------------------------------ //
...
if ('add' == $op) {
    ...
    $barcolor_array = XoopsLists::getImgListAsArray(XOOPS_ROOT_PATH . '/modules/votos/images/colorbars/');
    ...
    for ($i = 0; $i < 10; $i++) {
        ...
        $color_select->setExtra("onchange='showImgSelected(\"option_color_image[" . $i . ']", "option_color[' . $i . ']", "modules/votos/images/colorbars", "", "' . XOOPS_URL . "\")'");

        $color_label = new XoopsFormLabel('', "<img src='" . XOOPS_URL . '/modules/votos/images/colorbars/' . $current_bar . "' name='option_color_image[" . $i . "]' id='option_color_image[" . $i . "]' width='30' align='bottom' height='15' alt=''><br>");
...
if ('edit' == $op) {
    ...
    foreach ($options_arr as $option) {
        ...
        $color_label = new XoopsFormLabel('', "<img src='" . XOOPS_URL . '/modules/votos/images/colorbars/' . $option->getVar('option_color', 'E') . "' name='option_color_image[" . $i . "]' id='option_color_image[" . $i . "]' width='30' align='bottom' height='15' alt=''><br>");
