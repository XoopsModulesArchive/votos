<?php
// $Id: votosrenderer.php,v 1.8 2005/02/14 14:23:58 okazu Exp $
// ------------------------------------------------------------------------ //
...
class XoopsPollRenderer
{
    ...
    {
        $content = "<form action='" . XOOPS_URL . "/modules/votos/index.php' method='post'>";
        ...
        $content .= "<input type='button' value='" . _PL_RESULTS . "' class='button' onclick='location=\"" . XOOPS_URL . '/modules/votos/pollresults.php?poll_id=' . $this->poll->getVar('poll_id') . "\"'>";
    ...
    public function assignForm($tpl)
    {
        ...
        $tpl->assign(
            'poll',
            ['question' => $this->poll->getVar('question'), 'pollId' => $this->poll->getVar('poll_id'), 'viewresults' => XOOPS_URL . '/modules/votos/pollresults.php?poll_id=' . $this->poll->getVar('poll_id'), 'action' => XOOPS_URL . '/modules/votos/index.php', 'options' => $options]
        );
    }
    ...
    public function renderResults()
    {
        ...
        foreach ($options_arr as $option) {
            ...
            if ($percent > 0) {
                ...
                echo "<img src='" . XOOPS_URL . '/modules/votos/images/colorbars/' . $option->getVar('option_color', 'E') . "' height='14' width='" . $width . "' align='middle' alt='" . (int)$percent . " %'>";
            }
        ...
        if (!$this->poll->hasExpired()) {
            echo "<br>[<a href='" . XOOPS_URL . '/modules/votos/index.php?poll_id=' . $this->poll->getVar('poll_id') . "'>" . _PL_VOTE . '</a>]';
        }
    ...
    public function assignResults($tpl)
    {
        ...
        foreach ($options_arr as $option) {
            ...
            if ($percent > 0) {
                ...
                $options[$i]['image'] = "<img src='" . XOOPS_URL . '/modules/votos/images/colorbars/' . $option->getVar('option_color', 'E') . "' height='14' width='" . $width . "' align='middle' alt='" . (int)$percent . " %'>";
            }
        ...
        if (!$this->poll->hasExpired()) {
            $vote = "<a href='" . XOOPS_URL . '/modules/votos/index.php?poll_id=' . $this->poll->getVar('poll_id') . "'>" . _PL_VOTE . '</a>';
        }
